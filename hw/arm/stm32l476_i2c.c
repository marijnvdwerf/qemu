...
static void stm32l476_i2c_reset(DeviceState *dev)
{
    STM32L476I2CState *s = STM32L476_I2C(dev);
}

static uint64_t stm32l476_i2c_read(void *opaque, hwaddr offset,
                                   unsigned int size)
{
...
static void stm32l476_i2c_write(void *opaque, hwaddr offset, uint64_t val64,
                                unsigned int size)
{
    STM32L476I2CState *s = opaque;
    assert(size == 4);
    ...
    case I2C_CR2: {
        ...
        if (s->START && !s->BUSY) {
            s->BUSY = true;
            i2c_start_transfer(s->bus, (s->SADD & 0b0011111110) >> 1,
                               s->RD_WRN == 1);
        }
        s->TXIS = true;
        break;
...
static void stm32l476_i2c_realize(DeviceState *dev, Error **errp)
{
    STM32L476I2CState *s = STM32L476_I2C(dev);
...
static void stm32l476_i2c_class_init(ObjectClass *klass, void *data)
{
...
static void stm32l476_i2c_register_types(void)
{
